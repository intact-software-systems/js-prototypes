...
export function createPromiseWrapperExecutor(supplier, durationMsecs) {
...
export function createPromiseExecutor(supplier, durationMsecs) {
    return supplier()
...
export const createLoanerWithWrappedPromise = (supplier, durationMsecs = HALF_HOUR) => {
    return new ComputeLoan(() => createPromiseWrapperExecutor(supplier, durationMsecs))
}

export const createLoanerWithPromise = (supplier, durationMsecs = HALF_HOUR) => {
